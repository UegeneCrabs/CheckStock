...
PROFILE_DESCRIPTIONS = {
    ...
    AccessProfile.SENIOR_MARKETPLACE_MANAGER: "Одна или несколько площадок. Операции со стоком, отмена перемещений и просмотр юнит-экономики. Изменение экономики закрыто.",
    AccessProfile.MARKETPLACE_LEAD: "Одна или несколько площадок. Операции со стоком, просмотр и изменение юнит-экономики.",
