...
def job_definitions() -> tuple[SyncJobDefinition, ...]:
    ...
    return (
        ...
        SyncJobDefinition(
            ...
            "Ежедневно 08:00–19:00 каждый час и 01:00 · МСК",
            True,
            "store_marketplaces",
            ("YANDEX MARKET",),
        ),
        ...
        SyncJobDefinition(
            ...
            "Дневная маржа WB",
            "Сохраняет наблюдения текущего дня, включая неполные параметры; история не восстанавливается текущими настройками.",
            "Каждые 30 минут",
            base,
            "stores",
        ),
