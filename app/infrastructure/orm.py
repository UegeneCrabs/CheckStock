...
class YandexStorefrontPriceRecord(OrmBase):
    ...
    buyer_seller_price: Mapped[float | None] = mapped_column(Float)
    pay_price: Mapped[float | None] = mapped_column(Float)
    pay_checked_at: Mapped[str | None] = mapped_column(String)
    pay_seller_price: Mapped[float | None] = mapped_column(Float)
    pay_buyer_price: Mapped[float | None] = mapped_column(Float)
    spp_percent: Mapped[float | None] = mapped_column(Float)
    spp_checked_at: Mapped[str | None] = mapped_column(String)
    pay_discount_percent: Mapped[float | None] = mapped_column(Float)
    pay_discount_checked_at: Mapped[str | None] = mapped_column(String)
