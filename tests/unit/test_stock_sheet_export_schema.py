...
def test_cabinet_settings_are_migrated_to_current_commissions_and_taxes(tmp_path, monkeypatch) -> None:
    ...
    with database_for_path(path).connect() as connection:
        ...
        row = connection.execute(
            """
            SELECT default_buyout_percent, buyout_period_days, acquiring_percent, team_commission_percent, vat_percent,
    ...
    assert "default_buyout_percent" in columns
    ...
    assert row["default_buyout_percent"] is None
