...
class HttpServiceIntegrationTests(unittest.TestCase):
    ...
    def test_all_openapi_services_have_integration_ownership(self) -> None:
        ...
        owned = {
            ...
            "/sales/unit-economics-1c/reports/target-price",
            "/api/unit-economics-1c/reports/target-price",
            "/api/unit-economics-1c/reports/target-price.xlsx",
            "/api/unit-economics-1c/reports/target-price/{store_slug}/targets",
