...
def arguments(argv=None):
    ...
    parser.add_argument(
        "--loop", action="store_true", help="Ежедневно в 01:00 и 08:00–19:00 каждый час, Екатеринбург"
    )
            ...
            with sync_playwright() as playwright:
                ...
                try:
                    ...
                    while True:
                        ...
                        try:
                            report = run_tracked(
                                JOB, "scheduled" if args.loop else "manual", lambda: run_once(browser, args)
                            )
