(function () {
    ...
    window.YandexEconomicsFields = {
        ...
        hints: {
            commission_rub: 'Измените сумму — процент комиссии и чистая прибыль пересчитаются. При изменении цены сохраняется выбранный процент.',
            acquiring_percent: 'Перевод платежа от цены продавца. По умолчанию 1,6%; настраивается в параметрах кабинета.',
            seller_price: 'Изменение любой из трёх цен пересчитывает остальные с сохранением СПП и скидки Пэй, если эти скидки известны.',
            buyer_price: 'Цена покупателя без скидки по карте Пэй. Остальные цены пересчитываются с сохранением известных скидок.',
            pay_price: 'Цена покупателя с картой Пэй. Цена без СПП и цена с СПП пересчитываются по известным скидкам.',
